...
<html>
  <head>
    ...
    <link rel="stylesheet" charset="UTF-8" href="css/chart_self.css">
    ...
    <script src="js/chart/chart_self.js"       type="text/javascript" charset="utf-8"></script>
  </head>
<body>
  <!-- Start : header -->
